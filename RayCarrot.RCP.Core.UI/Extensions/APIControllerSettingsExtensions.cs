...
namespace RayCarrot.RCP.Core.UI
{
    ...
    public static class APIControllerSettingsExtensions
    {
        ...
        {
            // Set the settings
            controllerSettings.CustomSettings["RayCarrot.RCP.Core.UI"] = settings;
        ...
        public static APIControllerUISettings GetUISettings(this APIControllerSettings controllerSettings)
        {
            ...
            return controllerSettings.CustomSettings.TryGetValue("RayCarrot.RCP.Core.UI") as APIControllerUISettings ?? throw new Exception("UI settings have not been set");
        }
    }
}
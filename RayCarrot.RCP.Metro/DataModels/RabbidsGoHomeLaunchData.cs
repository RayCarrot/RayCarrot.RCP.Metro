...
namespace RayCarrot.RCP.Metro
{
    ...
    public class RabbidsGoHomeLaunchData
    {
        ...
        /// </summary>
        public RabbidsGoHomeLaunchData(string bigFile, string language, int resolutionX, int resolutionY, bool isVSyncEnabled, bool isFullscreen, int versionIndex, string[] optionalCommands)
        {
            BigFile = bigFile;
            Language = language;

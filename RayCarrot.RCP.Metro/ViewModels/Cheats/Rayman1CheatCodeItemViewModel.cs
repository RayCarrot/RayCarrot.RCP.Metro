namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class Rayman1CheatCodeItemViewModel : BaseCheatCodeItemViewModel
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        ...
        public Rayman1CheatCodeItemViewModel(string cheatDescription, string inputLocation, string input1, string input2, string input3) : base(cheatDescription, inputLocation)
        {
            Input1 = input1;
            Input2 = input2;
            Input3 = input3;

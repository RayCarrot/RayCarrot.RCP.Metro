...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class Utility_Decoder_R3Save : IUtility
    {
        #region Constructor
        ...
        /// Default constructor
        /// </summary>
        public Utility_Decoder_R3Save()
        {
            ViewModel = new Utility_Decoder_R3Save_ViewModel();
        }
        ...
        /// The view model
        /// </summary>
        public Utility_Decoder_R3Save_ViewModel ViewModel { get; }

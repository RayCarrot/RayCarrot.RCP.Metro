...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class Ray1EditorUtility : IUtility
    {
        #region Constructor
        ...
        /// Default constructor
        /// </summary>
        public Ray1EditorUtility()
        {
            ViewModel = new Ray1EditorUtilityViewModel();
        }
        ...
        /// </summary>
        public object UIContent => new Ray1EditorUtilityUI(ViewModel);
        ...
        /// The view model
        /// </summary>
        public Ray1EditorUtilityViewModel ViewModel { get; }

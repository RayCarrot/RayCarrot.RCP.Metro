...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class IPKArchiveExplorerUtility : IUtility
    {
        #region Constructor
        ...
        /// Default constructor
        /// </summary>
        public IPKArchiveExplorerUtility()
        {
            ViewModel = new IPKArchiveExplorerUtilityViewModel();
        }
        ...
        /// The view model
        /// </summary>
        public IPKArchiveExplorerUtilityViewModel ViewModel { get; }

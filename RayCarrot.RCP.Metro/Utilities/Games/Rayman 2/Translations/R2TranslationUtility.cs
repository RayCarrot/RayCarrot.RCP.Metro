...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class R2TranslationUtility : IUtility
    {
        #region Constructor
        ...
        /// </summary>
        public object UIContent => new R2TranslationUtilityUI()
        {
        ...
        /// </summary>
        public bool RequiresAdmin => !RCPServices.File.CheckFileWriteAccess(ViewModel.GetFixSnaFilePath());

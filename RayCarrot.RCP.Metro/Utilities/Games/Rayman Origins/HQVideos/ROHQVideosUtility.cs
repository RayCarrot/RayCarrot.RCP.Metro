...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class ROHQVideosUtility : IUtility
    {
        #region Constructor
        ...
        /// </summary>
        public object UIContent => new ROHQVideosUtilityUI()
        {
        ...
        /// </summary>
        public bool RequiresAdmin => !RCPServices.File.CheckFileWriteAccess(ViewModel.VideoDir + "intro.bik");

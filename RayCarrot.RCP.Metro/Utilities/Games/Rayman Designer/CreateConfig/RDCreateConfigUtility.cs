...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class RDCreateConfigUtility : IUtility
    {
        #region Constructor
        ...
        /// </summary>
        public bool RequiresAdmin => ViewModel.ConfigPath.FileExists && !RCPServices.File.CheckFileWriteAccess(ViewModel.ConfigPath);

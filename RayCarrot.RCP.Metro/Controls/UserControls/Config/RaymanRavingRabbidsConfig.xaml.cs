...
namespace RayCarrot.RCP.Metro
{
    ...
    public class RaymanRavingRabbidsConfigViewModel : GameConfigViewModel
    {
        ...
        public override Task SetupAsync()
        {
            ...
            using (var key = RCFWinReg.RegistryManager.GetKeyFromFullPath(RCFWinReg.RegistryManager.CombinePaths(CommonPaths.RavingRabbidsRegistryKey, "Basic video"), RegistryView.Default))
            {

...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public sealed class RaymanRedemption_Win32 : RCPWin32Game
    {
        ...
        {
            new GamePurchaseLink(Resources.GameDisplay_GameJolt, "https://gamejolt.com/games/raymanredemption/340532", PackIconMaterialKind.Earth), 
        };
        ...
        public override IList<OverflowButtonItemViewModel> GetAdditionalOverflowButtonItems => new OverflowButtonItemViewModel[]
        {
            ...
            {
                (await RCPServices.File.LaunchFileAsync("https://gamejolt.com/games/raymanredemption/340532"))?.Dispose();

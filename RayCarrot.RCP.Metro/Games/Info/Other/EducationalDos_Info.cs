...
namespace RayCarrot.RCP.Metro
{
    ...
    public sealed class EducationalDos_Info : RCPGameInfo
    {
        ...
        /// </summary>
        public override GameOptions_ConfigPageViewModel ConfigPageViewModel => new RaymanEduDosConfigViewModel(Game);
        ...
        /// </summary>
        public override Emulator Emulator => new DOSBoxEmulator(Game, GameType.EducationalDosBox);

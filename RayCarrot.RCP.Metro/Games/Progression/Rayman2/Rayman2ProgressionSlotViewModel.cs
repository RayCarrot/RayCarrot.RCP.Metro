...
namespace RayCarrot.RCP.Metro
{
    ...
    public class Rayman2ProgressionSlotViewModel : ProgressionSlotViewModel
    {
        ...
        protected override Task ExportSaveDataAsync(FileSystemPath outputFilePath)
        {
            ...
            var data = BinarySerializableHelpers.ReadFromStream<Rayman2PCSaveData>(decodedDataStream, OpenSpaceSettings.GetDefaultSettings(OpenSpaceGame.Rayman2, Platform.PC), RCPServices.App.GetBinarySerializerLogger());
        ...
        protected override Task ImportSaveDataAsync(FileSystemPath inputFilePath)
        {
            ...
            // Import the data
            BinarySerializableHelpers.WriteToStream(data, decodedDataStream, OpenSpaceSettings.GetDefaultSettings(OpenSpaceGame.Rayman2, Platform.PC), RCPServices.App.GetBinarySerializerLogger());

...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class Rayman2ProgressionSlotViewModel : ProgressionSlotViewModel
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        ...
        public Rayman2ProgressionSlotViewModel(LocalizedString slotName, ProgressionInfoItemViewModel[] items, FileSystemPath saveSlotFilePath, BaseProgressionViewModel progressionViewModel) : base(slotName, items, saveSlotFilePath, progressionViewModel)
        {
        ...
        protected override Task ExportSaveDataAsync(FileSystemPath outputFilePath)
        {
            ...
            var data = BinarySerializableHelpers.ReadFromStream<Rayman2PCSaveData>(decodedDataStream, OpenSpaceSettings.GetDefaultSettings(OpenSpaceGame.Rayman2, Platform.PC), RCPServices.App.GetBinarySerializerLogger(SaveSlotFilePath.Name));
        ...
        protected override Task ImportSaveDataAsync(FileSystemPath inputFilePath)
        {
            ...
            // Import the data
            BinarySerializableHelpers.WriteToStream(data, decodedDataStream, OpenSpaceSettings.GetDefaultSettings(OpenSpaceGame.Rayman2, Platform.PC), RCPServices.App.GetBinarySerializerLogger(SaveSlotFilePath.Name));

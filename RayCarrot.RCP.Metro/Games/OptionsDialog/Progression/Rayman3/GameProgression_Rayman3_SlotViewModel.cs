...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class GameProgression_Rayman3_SlotViewModel : GameProgression_BaseSlotViewModel
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        ...
        public GameProgression_Rayman3_SlotViewModel(LocalizedString slotName, GameProgression_InfoItemViewModel[] items, FileSystemPath saveSlotFilePath, GameProgression_BaseViewModel progressionViewModel) : base(slotName, items, saveSlotFilePath, progressionViewModel)
        {
        ...
        protected override Task ExportSaveDataAsync(FileSystemPath outputFilePath)
        {
            ...
            var data = BinarySerializableHelpers.ReadFromStream<Rayman3PCSaveData>(decodedDataStream, OpenSpaceSettings.GetDefaultSettings(OpenSpaceGame.Rayman3, Platform.PC), RCPServices.App.GetBinarySerializerLogger(SaveSlotFilePath.Name));
        ...
        protected override Task ImportSaveDataAsync(FileSystemPath inputFilePath)
        {
            ...
            // Import the data
            BinarySerializableHelpers.WriteToStream(data, decodedDataStream, OpenSpaceSettings.GetDefaultSettings(OpenSpaceGame.Rayman3, Platform.PC), RCPServices.App.GetBinarySerializerLogger(SaveSlotFilePath.Name));

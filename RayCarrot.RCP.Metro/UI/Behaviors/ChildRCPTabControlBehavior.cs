...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class ChildRCPTabControlBehavior : Behavior<UIElement>
    {
        ...
        public static readonly DependencyProperty ChildTabControlProperty = DependencyProperty.Register(nameof(ChildTabControl), typeof(TabControl), typeof(ChildRCPTabControlBehavior), new FrameworkPropertyMetadata());

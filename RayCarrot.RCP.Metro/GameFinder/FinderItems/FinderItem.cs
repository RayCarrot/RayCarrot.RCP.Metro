...
namespace RayCarrot.RCP.Metro
{
    ...
    public class FinderItem : BaseFinderItem
    {
        ...
        public FinderItem(string[] possibleWin32Names, string shortcutName, Func<FileSystemPath, FileSystemPath?> verifyInstallDirectory, Action<FileSystemPath, object> foundAction, string displayName, Func<FoundActionResult> customFinderAction = null) : base(possibleWin32Names, shortcutName, verifyInstallDirectory, foundAction, customFinderAction)
        {

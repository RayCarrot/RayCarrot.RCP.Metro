...
namespace RayCarrot.RCP.Metro
{
    ...
    public class GameFinderResult : BaseFinderResult
    {
        ...
        public GameFinderResult(Games game, FileSystemPath installLocation, GameType gameType, Action<FileSystemPath, object> handledAction = null, object handledParameter = null) : base(installLocation, handledAction, handledParameter)
        {
            Game = game;
            GameType = gameType;
        }
        ...
        public override async Task HandleItemAsync()
        {
            ...
            // Add the game
            await RCFRCP.App.AddNewGameAsync(Game, GameType, InstallLocation);
        }
    }
}
...
{
    public RCPUpdaterManager(IMessageUIManager message, FileManager file, DeployableFilesManager deployableFiles, AppUserData data, IAppInstanceData instanceData) : base(message, file, deployableFiles, data, instanceData) { }

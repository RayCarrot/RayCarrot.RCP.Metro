...
// TODO-UPDATE: Update this to support new mod loader
public class LegacyPatchFileURILaunchHandler : URILaunchHandler
{
    ...
    public override async void Invoke(string uri, State state)
    {
        ...
        try
        {
            ...
            // Show the Patcher
            await Services.UI.ShowModLoaderAsync(patchFiles.Select(x => new FileSystemPath(x)).ToArray());
        }
        catch (Exception ex)
        {

...
{
    public GameProgressionManager_RaymanEdutainment_MsDos(GameInstallation gameInstallation, string progressionId, string primaryName, Ray1MsDosData.Version version) 

    ...
    where FileObj : BinarySerializable, new()
{
    ...
    public BinarySerializableProgressionSlotViewModel(ProgressionGameViewModel game, LocalizedString? name, int index, double percentage, IEnumerable<ProgressionDataViewModel> dataItems, Context context, FileObj serializable, string fileName) : base(game, name, index, percentage, dataItems)
    {
        Context = context;
        Serializable = serializable;
        FileName = fileName;

...
public abstract class GameManager_EducationalDOSBox : GameManager_DOSBox
{
    ...
    public void RefreshDefault()
    {
        ...
        Services.Data.Game_GameInstallations.Add(new GameInstallation(gameInstallation.Game, gameInstallation.GameType, Services.Data.Game_EducationalDosBoxGames.First().InstallDir, gameInstallation.IsRCPInstalled));

...
public class GameFinder
{
    ...
    /// </summary>
    protected GameFinder_GenericItem[] FinderItems { get; }

    /// <summary>
    /// The found finder items
    /// </summary>
    protected List<GameFinder_GenericItem> FoundFinderItems { get; }
    ...
    /// </summary>
    protected List<GameFinder_BaseResult> Results { get; }
    ...
    protected virtual async Task SearchWin32ShortcutsAsync(IEnumerable<string> shortcuts, List<GameFinderItemContainer> programShortcutGameFinders, List<GameFinder_GenericItem> programShortcutFinders)
    {
    ...
    /// <returns>The task</returns>
    protected virtual async Task SearchRegistryUninstallAsync(IEnumerable<InstalledProgram> installedPrograms, List<GameFinderItemContainer> regUninstallGameFinders, List<GameFinderItemContainer> steamGameFinders, List<GameFinder_GenericItem> regUninstallFinders)
    {
        // Enumerate each program

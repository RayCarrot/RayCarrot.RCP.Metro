...
public class DosBoxGameConfigViewModel : GameClientGameConfigPageViewModel
{
    ...
    protected override Task LoadAsync()
    {
        ...
        Logger.Info("DOSBox game client game config for {0} has been loaded", GameInstallation.FullId);
    ...
    protected override async Task<bool> SaveAsync()
    {
        ...
        try
        {
            ...
            Logger.Info("DOSBox game client game config for {0} has been saved", GameInstallation.FullId);
        ...
        {
            Logger.Error(ex, "Saving DOSBox game client game config data");

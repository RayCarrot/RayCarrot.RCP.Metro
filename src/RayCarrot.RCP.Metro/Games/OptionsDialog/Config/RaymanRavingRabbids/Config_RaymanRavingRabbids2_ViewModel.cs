...
namespace RayCarrot.RCP.Metro
{
    public class Config_RaymanRavingRabbids2_ViewModel : Config_RaymanRavingRabbids_ViewModel
    {
        ...
        protected override string GetGUID()
        {
            ...
            return Services.Data.Game_RRR2LaunchMode switch
            {
                UserData_RRR2LaunchMode.AllGames => "{B864EBC6-9DB8-4A5E-9F08-B0CE286785EC}",
                ...
                _ => throw new ArgumentOutOfRangeException(nameof(Services.Data.Game_RRR2LaunchMode),
                    Services.Data.Game_RRR2LaunchMode, null)
            };
        }

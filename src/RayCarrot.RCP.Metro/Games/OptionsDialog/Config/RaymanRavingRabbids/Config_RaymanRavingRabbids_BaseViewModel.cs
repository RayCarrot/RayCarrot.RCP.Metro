...
/// </summary>
public abstract class Config_RaymanRavingRabbids_BaseViewModel : GameOptionsDialog_ConfigPageViewModel
{
    #region Constructor

    protected Config_RaymanRavingRabbids_BaseViewModel(GameInstallation gameInstallation)
    {

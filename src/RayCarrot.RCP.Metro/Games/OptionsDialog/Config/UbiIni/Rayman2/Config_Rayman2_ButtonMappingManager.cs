...
/// </summary>
public static class Config_Rayman2_ButtonMappingManager
{
    ...
    public static async Task<HashSet<Config_Rayman2_ButtonMappingItem>> LoadCurrentMappingAsync(FileSystemPath dllFile)
    {
        var output = new HashSet<Config_Rayman2_ButtonMappingItem>();
        ...
        while (originalKey > 0)
        {
            ...
            output.Add(new Config_Rayman2_ButtonMappingItem(originalKey, newKey));
    ...
    public static async Task ApplyMappingAsync(FileSystemPath dllFile, List<Config_Rayman2_ButtonMappingItem> items)
    {

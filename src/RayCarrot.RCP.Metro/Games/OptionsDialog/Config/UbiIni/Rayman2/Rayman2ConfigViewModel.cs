...
public class Rayman2ConfigViewModel : UbiIniBaseConfigViewModel<UbiIniData_Rayman2>
{
    ...
    public Rayman2ConfigViewModel(GameInstallation gameInstallation) : base(gameInstallation)
    {
        ...
        try
        {
            ...
            else
            {
                var items = KeyItems.
                    ...
                    Select(x => new Rayman2ConfigButtonMappingItem(DirectXKeyHelpers.GetKeyCode(x.OriginalKey), DirectXKeyHelpers.GetKeyCode(x.NewKey))).
                    // Convert to a list
                    ToList();
                ...
                if (items.Any())
                {
                    ...
                    // Apply the patch
                    await Rayman2ConfigButtonMappingManager.ApplyMappingAsync(path, items);
                }
                else
                {

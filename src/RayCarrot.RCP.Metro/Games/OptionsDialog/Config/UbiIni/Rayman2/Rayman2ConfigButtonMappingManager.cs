...
/// </summary>
public static class Rayman2ConfigButtonMappingManager
{
    ...
    public static async Task<HashSet<Rayman2ConfigButtonMappingItem>> LoadCurrentMappingAsync(FileSystemPath dllFile)
    {
        var output = new HashSet<Rayman2ConfigButtonMappingItem>();
        ...
        while (originalKey > 0)
        {
            ...
            output.Add(new Rayman2ConfigButtonMappingItem(originalKey, newKey));
    ...
    public static async Task ApplyMappingAsync(FileSystemPath dllFile, List<Rayman2ConfigButtonMappingItem> items)
    {

...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class GameProgression_RaymanDesigner_SlotViewModel : GameProgression_BaseSlotViewModel
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        ...
        public GameProgression_RaymanDesigner_SlotViewModel(LocalizedString slotName, GameProgression_InfoItemViewModel[] items, GameProgression_BaseViewModel progressionViewModel) : base(slotName, items, FileSystemPath.EmptyPath, progressionViewModel)
        {

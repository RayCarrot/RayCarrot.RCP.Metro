...
public class GameProgression_Rayman1_SlotViewModel : GameProgression_BaseSlotViewModel
{
    ...
    protected override Task ExportSaveDataAsync(FileSystemPath outputFilePath)
    {
        ...
        var data = BinarySerializableHelpers.ReadFromStream<Rayman1PCSaveData>(decodedDataStream, Ray1Settings.GetDefaultSettings(Ray1Game.Rayman1, Platform.PC), Services.App.GetBinarySerializerLogger(SaveSlotFilePath.Name));
    ...
    protected override Task ImportSaveDataAsync(FileSystemPath inputFilePath)
    {
        ...
        // Import the data
        BinarySerializableHelpers.WriteToStream(data, decodedDataStream, Ray1Settings.GetDefaultSettings(Ray1Game.Rayman1, Platform.PC), Services.App.GetBinarySerializerLogger(SaveSlotFilePath.Name));

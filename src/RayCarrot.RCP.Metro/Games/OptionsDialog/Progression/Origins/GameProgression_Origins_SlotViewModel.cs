...
namespace RayCarrot.RCP.Metro
{
    ...
    /// </summary>
    public class GameProgression_Origins_SlotViewModel : GameProgression_BaseSlotViewModel
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        ...
        public GameProgression_Origins_SlotViewModel(LocalizedString slotName, GameProgression_InfoItemViewModel[] items, FileSystemPath saveSlotFilePath, GameProgression_BaseViewModel progressionViewModel) : base(slotName, items, saveSlotFilePath, progressionViewModel)
        { }
        ...
        protected override Task ExportSaveDataAsync(FileSystemPath outputFilePath)
        {
            ...
            var data = BinarySerializableHelpers.ReadFromFile<OriginsPCSaveData>(SaveSlotFilePath, UbiArtSettings.GetSaveSettings(UbiArtGame.RaymanOrigins, Platform.PC), Services.App.GetBinarySerializerLogger(SaveSlotFilePath.Name));
        ...
        protected override Task ImportSaveDataAsync(FileSystemPath inputFilePath)
        {
            ...
            // Import the data
            BinarySerializableHelpers.WriteToFile<OriginsPCSaveData>(data, SaveSlotFilePath, UbiArtSettings.GetSaveSettings(UbiArtGame.RaymanOrigins, Platform.PC), Services.App.GetBinarySerializerLogger(SaveSlotFilePath.Name));

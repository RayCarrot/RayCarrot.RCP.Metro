...
/// </summary>
public class GameProgression_Origins_ViewModel : GameProgression_BaseViewModel
{
    #region Constructor
    ...
    /// Default constructor
    /// </summary>
    public GameProgression_Origins_ViewModel() : base(Games.RaymanJungleRun)
    {
    ...
    protected GameProgression_BaseSlotViewModel GetProgressionSlotViewModel(FileSystemPath filePath, Func<string> slotNamegenerator)
    {
        ...
        var saveData = BinarySerializableHelpers.ReadFromFile<OriginsPCSaveData>(filePath, UbiArtSettings.GetSaveSettings(UbiArtGame.RaymanOrigins, Platform.PC), Services.App.GetBinarySerializerLogger(filePath.Name)).SaveData;

...
/// <summary>
/// The Rayman 1 minigames game descriptor
/// </summary>
public sealed class GameDescriptor_Ray1Minigames_Win32 : Win32GameDescriptor
{
    #region Public Override Properties

    public override string Id => "Ray1Minigames_Win32";
    public override Game Game => Game.Ray1Minigames;

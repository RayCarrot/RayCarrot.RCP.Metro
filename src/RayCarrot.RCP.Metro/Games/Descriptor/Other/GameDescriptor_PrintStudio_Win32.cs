...
/// <summary>
/// The Rayman 3 Print Studio game descriptor
/// </summary>
public sealed class GameDescriptor_PrintStudio_Win32 : Win32GameDescriptor
{
    #region Public Override Properties

    public override string Id => "PrintStudio_Win32";
    public override Game Game => Game.PrintStudio;

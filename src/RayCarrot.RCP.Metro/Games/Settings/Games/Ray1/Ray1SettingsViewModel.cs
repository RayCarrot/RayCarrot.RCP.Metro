...
public class Ray1SettingsViewModel : GameSettingsViewModel
{
    #region Constructor

    public Ray1SettingsViewModel(GameInstallation gameInstallation) : base(gameInstallation)
    {
    ...
    protected override Task LoadAsync()
    {
        ...
        AddSettingsLocation(LinkItemViewModel.LinkType.BinaryFile, GameInstallation.InstallLocation.Directory + ConfigFileName);

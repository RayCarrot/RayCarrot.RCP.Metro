...
public sealed class GameInfo_RaymanM : GameInfo
{
    ...
    /// </summary>
    public override GameOptionsDialog_ConfigPageViewModel ConfigPageViewModel => new Config_RaymanM_ViewModel();
    ...
    /// </summary>
    public override IArchiveDataManager GetArchiveDataManager => new OpenSpaceCntArchiveDataManager(new OpenSpaceSettings(EngineVersion.RaymanM, Platform.PC));

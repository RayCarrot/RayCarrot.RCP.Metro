...
public class Mod_R1_MemoryData
{
    ...
    public ObjData? Ray { get; set; } // TODO-UPDATE: Add some fields/info items for this
    ...
    public FinBossLevel FinBossLevel { get; set; } // TODO-UPDATE: Add some fields/info items for this

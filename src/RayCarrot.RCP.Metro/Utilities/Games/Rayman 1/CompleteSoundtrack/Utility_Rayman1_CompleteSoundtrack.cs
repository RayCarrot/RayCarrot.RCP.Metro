...
public class Utility_Rayman1_CompleteSoundtrack : IUtility
{
    ...
    public GenericIconKind Icon => GenericIconKind.Utilities_Rayman1_CompleteSoundtrack;
    ...
    /// </summary>
    public bool RequiresAdmin => !Services.File.CheckDirectoryWriteAccess(ViewModel.MusicDir);

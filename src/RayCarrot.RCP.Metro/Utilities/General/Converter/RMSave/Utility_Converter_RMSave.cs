...
/// </summary>
public class Utility_Converter_RMSave : IUtility
{
    #region Constructor
    ...
    /// Default constructor
    /// </summary>
    public Utility_Converter_RMSave()
    {
        ViewModel = new Utility_Converter_RMSave_ViewModel();
    }
    ...
    /// The view model
    /// </summary>
    public Utility_Converter_RMSave_ViewModel ViewModel { get; }

...
/// </summary>
public class Utility_Converter_LOC : IUtility
{
    #region Constructor
    ...
    /// Default constructor
    /// </summary>
    public Utility_Converter_LOC()
    {
        ViewModel = new Utility_Converter_LOC_ViewModel();
    }
    ...
    /// The view model
    /// </summary>
    public Utility_Converter_LOC_ViewModel ViewModel { get; }

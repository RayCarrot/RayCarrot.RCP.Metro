...
/// </summary>
public class Utility_Converter_R2Save : IUtility
{
    #region Constructor
    ...
    /// Default constructor
    /// </summary>
    public Utility_Converter_R2Save()
    {
        ViewModel = new Utility_Converter_R2Save_ViewModel();
    }
    ...
    /// The view model
    /// </summary>
    public Utility_Converter_R2Save_ViewModel ViewModel { get; }

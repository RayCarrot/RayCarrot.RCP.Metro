...
/// </summary>
public class Utility_Serializers : IUtility
{
    #region Constructor
    ...
    {
        ViewModel = new Utility_Serializers_ViewModel();
    }
    ...
    /// </summary>
    public object UIContent => new Utility_Serializers_UI() { DataContext = ViewModel };
    ...
    /// The view model
    /// </summary>
    public Utility_Serializers_ViewModel ViewModel { get; }

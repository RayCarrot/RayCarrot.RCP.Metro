...
{
    /// <summary>
    /// The Rayman 1 and 2 .sav decoder utility
    /// </summary>
    public class Utility_Decoder_R12Save : IUtility
    {
        #region Constructor
        ...
        /// Default constructor
        /// </summary>
        public Utility_Decoder_R12Save()
        {
            ViewModel = new Utility_Decoder_R12Save_ViewModel();
        }
        ...
        /// The view model
        /// </summary>
        public Utility_Decoder_R12Save_ViewModel ViewModel { get; }

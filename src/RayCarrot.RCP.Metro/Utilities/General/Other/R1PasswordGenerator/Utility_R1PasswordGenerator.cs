...
/// </summary>
public class Utility_R1PasswordGenerator : IUtility
{
    #region Constructor
    ...
    /// Default constructor
    /// </summary>
    public Utility_R1PasswordGenerator()
    {
        ViewModel = new Utility_R1PasswordGenerator_ViewModel();
    }
    ...
    /// </summary>
    public object UIContent => new Utility_R1PasswordGenerator_UI(ViewModel);
    ...
    /// The view model
    /// </summary>
    public Utility_R1PasswordGenerator_ViewModel ViewModel { get; }

...
public class FileExistsValidationRule : ValidationRule
{
    ...
    public override ValidationResult Validate(object value, CultureInfo cultureInfo)
    {
        ...
        return (String.IsNullOrEmpty(input) && AllowEmpty) || File.Exists(input) ? ValidationResult.ValidResult : new ValidationResult(false, Resources.BrowseBox_ValidationError_FileExists);
    }
}
...
public class Card : ContentControl
{
    ...
    protected override void OnRenderSizeChanged(SizeChangedInfo sizeInfo)
    {
        ...
        double farPointX = Math.Max(0, _clipBorder.ActualWidth);
        double farPointY = Math.Max(0, _clipBorder.ActualHeight);
        Point farPoint = new(farPointX, farPointY);

        Rect clipRect = new(new Point(0, 0), farPoint);

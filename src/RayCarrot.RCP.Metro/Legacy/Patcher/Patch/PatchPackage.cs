...
/// </summary>
public class PatchPackage : BinarySerializable, IPackageFile
{
    #region Constants
    ...
    /// </summary>
    public PatchPackageMetadata Metadata { get; set; }
    ...
    public override void SerializeImpl(SerializerObject s)
    {
        s.DoWithDefaults(new SerializerDefaults() { StringEncoding = Encoding.UTF8 }, () =>
        {
            ...
            Metadata = s.SerializeObject<PatchPackageMetadata>(Metadata, x => x.Pre_FormatVersion = FormatVersion, name: nameof(Metadata));

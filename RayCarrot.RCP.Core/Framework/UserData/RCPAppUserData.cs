...
namespace RayCarrot.RCP.Core
{
    ...
    public class RCPAppUserData : BaseViewModel, IUserData
    {
        ...
        /// </summary>
        [JsonIgnore]
        public FileSystemPath FilePath => RCFRCPC.Path.GetUserDataFile(GetType());
        ...
        {
            get => RCFCore.Data.CurrentCulture?.Name ?? RCFRCPC.Localization.DefaultCulture.Name;
            set => RCFRCPC.Localization.SetCulture(value);
        }
